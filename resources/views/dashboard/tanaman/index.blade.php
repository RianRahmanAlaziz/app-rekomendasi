                ...
                <div class="card border shadow-lg mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Data Tanaman</h6>
                                <p class="text-sm"></p>
                            </div>
                            <div class="ms-auto d-flex">
                                <button type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2"
                                    ...
                                    <span class="btn-inner--text">Add Data Tanaman</span>
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover align-items-center mb-0">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="text-secondary text-xs font-weight-semibold opacity-7">Nama Tanaman
                                        </th>
                                    ...
                                    @forelse ($tanamans as $item)
                                        <tr>
                                            <td class="text-center align-middle text-secondary text-sm font-weight-normal">
                                                {{ ($tanamans->currentPage() - 1) * $tanamans->perPage() + $loop->iteration }}
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/assets/img/tanaman/{{ $item->gambar }}"
                                            ...
                                            <td class="text-center align-middle bg-transparent border-bottom">
                                                <button type="button" class="btn" data-bs-toggle="modal"
                                                    data-bs-target="#edittanaman-{{ $item->id }}"><i
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="/dashboard/data-tanaman/{{ $item->id }}" method="POST">
                            @method('DELETE')
                            @csrf
