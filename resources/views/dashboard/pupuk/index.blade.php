    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end mb-4">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-pupuk">Tambah
                    Data</button>
                    ...
                    <tbody>
                        @foreach ($pupuks as $pupuk)
                            <tr>
                                ...
                                <td>{{ $pupuk->nama }}</td>
                                <td>{{ $pupuk->kandungan }}</td>
                                <td> @rupiah($pupuk->harga) </td>
                                <td>{{ $pupuk->deskripsi }}</td>
                                <td><img src="/assets/img/pupuk/{{ $pupuk->gambar }}" width="100" alt="">
                                </td>
                                <td>
                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#modal-pupuk-edit-{{ $pupuk->id }}"><i
