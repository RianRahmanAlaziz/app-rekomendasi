                            ...
                            <table class="table table-hover align-items-center mb-0">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="text-secondary text-xs font-weight-semibold opacity-7">Judul
                                        </th>
                                    ...
                                    @forelse ($sliders as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/assets/img/slider/{{ $item->gambar }}"
                                            ...
                                            <td class="align-middle ">
                                                <span
                                                    class="text-secondary text-sm font-weight-normal">{{ $item->deskripsi }}</span>
                                            </td>
                                            <td class="text-center align-middle bg-transparent border-bottom">
                                                <button type="button" class="btn" data-bs-toggle="modal"
                                                    data-bs-target="#editslider-{{ $item->id }}"><i
                        ...
                        <div class="border-top py-3 px-3 d-flex align-items-center">
                            ...
                            <div class="ms-auto">
                                ...
                                @if ($sliders->hasMorePages())
                                    <a href="{{ $sliders->nextPageUrl() }}" class="btn btn-sm btn-white mb-0">Next</a>
                                @else
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="/dashboard/data-slider/{{ $item->id }}" method="POST">
                            @method('DELETE')
                            @csrf
