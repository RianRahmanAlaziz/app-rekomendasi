<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main"
    ...
    <div class="collapse navbar-collapse px-4  w-auto accordion" id="sidenav-collapse-main">
        <ul class="navbar-nav accordion" id="accordionSidebar">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ Request::is('dashboard/data-tanaman') ? 'active' : '' }}"
                    href="/dashboard/data-tanaman">
                    <span class="nav-link-text ms-1">Data Tanaman</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ Request::is('dashboard/data-pupuk') ? 'active' : '' }}"
                    href="/dashboard/data-pupuk">
                    <span class="nav-link-text ms-1">Data Pupuk</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ Request::is('dashboard/data-usia') ? 'active' : '' }}"
                    href="/dashboard/data-usia">
                    <span class="nav-link-text ms-1">Data Usia Tanam</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
