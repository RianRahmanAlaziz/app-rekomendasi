<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main"
    ...
    <div class="collapse navbar-collapse px-4  w-auto accordion" id="sidenav-collapse-main">
        <ul class="navbar-nav accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('dashboard/perhitungan') ? 'active' : '' }}"
                    href="/dashboard/perhitungan">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">

                        <svg xmlns="http://www.w3.org/2000/svg" fill="#ffff" viewBox="0 0 24 24" width="30px"
                            height="30px" stroke-width="1.5" stroke="currentColor" class="size-6">
